...
$pageurl = new moodle_url('/customfield/field/training/management/field_add.php', ['frameworkid' => $frameworkid]);
...
$form = new \customfield_training\local\form\field_add(null, ['framework' => $framework]);
...
echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('field_add', 'customfield_training'));
echo $form->render();
echo $OUTPUT->footer();
